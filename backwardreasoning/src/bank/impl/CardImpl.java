 ...
 * <ul>
 *   <li>{@link bank.impl.CardImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link bank.impl.CardImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CardImpl extends MinimalEObjectImpl.Container implements Card {
	 ...
	 * @ordered
	 */
	protected static final CardType TYPE_EDEFAULT = null;
	...
	public void setNumber(BigInteger newNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BankPackage.CARD__NUMBER, oldNumber, number));
	}
	...
	public void setType(CardType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BankPackage.CARD__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BankPackage.CARD__NUMBER:
				return getNumber();
			case BankPackage.CARD__TYPE:
				return getType();
		}
