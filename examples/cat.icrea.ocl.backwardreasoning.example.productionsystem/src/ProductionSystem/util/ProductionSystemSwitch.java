 ...
 * @generated
 */
public class ProductionSystemSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProductionSystemPackage.MACHINE: {
				Machine machine = (Machine)theEObject;
				T result = caseMachine(machine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProductionSystemPackage.CONVEYOR: {
				Conveyor conveyor = (Conveyor)theEObject;
				T result = caseConveyor(conveyor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProductionSystemPackage.PIECE: {
				Piece piece = (Piece)theEObject;
				T result = casePiece(piece);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProductionSystemPackage.RAW: {
				Raw raw = (Raw)theEObject;
				T result = caseRaw(raw);
				if (result == null) result = casePiece(raw);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProductionSystemPackage.PROCESSED: {
				Processed processed = (Processed)theEObject;
				T result = caseProcessed(processed);
				if (result == null) result = casePiece(processed);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Processed</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Processed</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProcessed(Processed object) {
		return null;
	}
