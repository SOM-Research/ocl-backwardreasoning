...
public class LookupExcludingVisitor extends AbstractVisitor<Set<OperationCallExp<EClassifier, EOperation>>, EClassifier, EOperation, EStructuralFeature, EEnumLiteral, EParameter, EObject, CallOperationAction, SendSignalAction, Constraint> {

	public LookupExcludingVisitor() {
		super();
	...
	public Set<OperationCallExp<EClassifier, EOperation>> visitOperationCallExp(OperationCallExp<EClassifier, EOperation> operation){
		...
		if(operation.getReferredOperation().getName().equals("excluding"))
